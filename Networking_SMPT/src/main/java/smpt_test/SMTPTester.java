...
public class SMTPTester {
     ...
     */
    public static void GmailSend(final String username, final String password, String recipientEmail, String ccEmail, String title, String message) throws AddressException, MessagingException {
	...
	public static void main(String[] args) throws AddressException, MessagingException {
		//MailTest();
		GmailSend("andtokm", "ziudjagaggggggggg", "andtokm@yandex.ru", "", "TEST_TITLE", "TEST_MESSAGE");
