...
public class DigitalSignatureUtils
{
    ...
    public static byte[] sign(byte[] message,
                              ...
                              PrivateKey signingKey) throws SecurityException
    {
        try {
    ...
    public static boolean verify(byte[] messageBytes,
                                 String signingAlgorithm,
                                 PublicKey publicKey,
                                 byte[] signedData)
    {
    ...
    public static byte[] signWithMessageDigestAndCipher(byte[] messageBytes,
    ...
    public static boolean verifyWithMessageDigestAndCipher(byte[] messageBytes,
                                                           String hashingAlgorithm,
                                                           PublicKey publicKey,
