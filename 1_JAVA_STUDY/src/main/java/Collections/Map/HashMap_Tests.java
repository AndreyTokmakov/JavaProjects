...
public class HashMap_Tests {
	...
	protected static void VariousTests()	{
		...
		suitesCounter.put("key1", 1);
		suitesCounter.put("key2", 5);
		suitesCounter.put("key3", 3);
		...
		String key = "key4";
		boolean result = suitesCounter.containsKey(key);
		System.out.println("\nMap contains kye '" + key + "' : " + result);
		
		key = "key2";
		result = suitesCounter.containsKey(key);
		System.out.println("Map contains kye '" + key + "' : " + result);
		
		Integer value = suitesCounter.get(key);
		System.out.println(value);
		
		suitesCounter.put(key, 44);
		
		value = suitesCounter.get(key);
		System.out.println(value + "\n'n");
		
		
		value = suitesCounter.get("Te3434");
		System.out.println(value);
