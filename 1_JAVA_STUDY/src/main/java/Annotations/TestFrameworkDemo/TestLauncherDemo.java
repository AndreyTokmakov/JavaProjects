...
package Annotations.TestFrameworkDemo;

import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

import Annotations.TestFrameworkDemo.test_annotations.ExceptionTest;
import Annotations.TestFrameworkDemo.test_annotations.ExceptionTestContainer;
import Annotations.TestFrameworkDemo.test_annotations.MultipleExceptionTest;
import Annotations.TestFrameworkDemo.test_annotations.MyTest;
import Annotations.TestFrameworkDemo.test_classes.ExceptionTestContainer_Tests;
import Annotations.TestFrameworkDemo.test_classes.ExceptionTests;
import Annotations.TestFrameworkDemo.test_classes.MultipleException_Tests;
import Annotations.TestFrameworkDemo.test_classes.MyTest_Tests;
	...
	public void run_multiple_exception_tests(String classname) throws Exception 
	{
		...
		for (final Method method : testClass.getDeclaredMethods()) 
		{
			...
			if (true == method.isAnnotationPresent(MultipleExceptionTest.class)) {
				try {
					method.invoke(null);
					System.out.printf("ERROR: Test %s failed: no exception%n", method);
				} 
				catch (InvocationTargetException wrappedException) {
					Throwable exception = wrappedException.getCause();
...
public class TestLauncherDemo {
	/** **/
	protected static final TestLauncher testLaucnher = new TestLauncher();
	
	public static void main(String[] args) throws Exception {
		 testLaucnher.run_tests(MyTest_Tests.class.getName());
