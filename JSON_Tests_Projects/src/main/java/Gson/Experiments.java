...
public class Experiments {
	...
	private static void Parser_CreateExtensionResponse() {
		final String json = """
                {\r
                	"creationTime": "2021-01-21T12:49:09.266Z",\r
                	"status": "Active",\r
                	"eventFilters": [\r
                		"/restapi/v1.0/account/402730421127/extension/402730423127/presence"\r
                	],\r
                	"expirationTime": "2021-03-20T09:42:29.266Z",\r
                	"expiresIn": 4999999,\r
                	"deliveryMode": {\r
                		"transportType": "WebHook",\r
                		"encryption": false,\r
                		"address": "http://fun01-c01-rce01.lab.nordigy.ru:6790/webhooks/raw/hook/FakeAddress_4806596726873066142"\r
                	}\r
                }""";
	...
	private static void Parser_CreateAGW_Error() {
		final String json = """
                {\r
                  "errorCode" : "AGW-111",\r
                  "message" : "Internal Server Error. Consult RC Support.",\r
                  "errors" : [ ]\r
                }""";
