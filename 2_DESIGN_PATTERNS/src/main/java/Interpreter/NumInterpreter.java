...
class ThousandExpression extends NumExpression {
...
class HundredExpression extends NumExpression {
...
class TenExpression extends NumExpression {
...
class OneExpression extends NumExpression {
...
public class NumInterpreter
{
    public static void main(String[] args) {
        ...
        ArrayList<NumExpression> tree = new ArrayList<NumExpression>();
        tree.add(new ThousandExpression());
        tree.add(new HundredExpression());
        tree.add(new TenExpression());
        tree.add(new OneExpression());

        for (NumExpression exp : tree) {
